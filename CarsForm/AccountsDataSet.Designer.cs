...
namespace Cars1 {
    ...
    public partial class AccountsDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsTableDataTable : global::System.Data.TypedTableBase<AccountsTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountsTableRow AddAccountsTableRow(string Username, string Password) {
...
namespace Cars1.AccountsDataSetTableAdapters {
    ...
    public partial class AccountsTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[AccountsTable] WHERE (([AccountID] = @Original_AccountID) AND " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[AccountsTable] ([Username], [Password]) VALUES (@Username, @Pa" +
                "ssword);\r\nSELECT AccountID, Username, Password FROM AccountsTable WHERE (Account" +
                "ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[AccountsTable] SET [Username] = @Username, [Password] = @Password WHERE (([AccountID] = @Original_AccountID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password));
SELECT AccountID, Username, Password FROM AccountsTable WHERE (AccountID = @AccountID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Cars1.Properties.Settings.Default.AccountsDatabase;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AccountID, Username, Password FROM dbo.AccountsTable";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[AccountsTable] ([Username], [Password]) VALUES (@Username, @Pa" +
                "ssword);\r\nSELECT AccountID, Username, Password FROM AccountsTable WHERE (Account" +
                "ID = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(AccountsDataSet.AccountsTableDataTable dataTable) {
        ...
        public virtual AccountsDataSet.AccountsTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AccountsDataSet.AccountsTableDataTable dataTable = new AccountsDataSet.AccountsTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AccountsDataSet.AccountsTableDataTable dataTable) {
        ...
        public virtual int Update(string Username, string Password, int Original_AccountID, string Original_Username, string Original_Password, int AccountID) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        public virtual int Update(string Username, string Password, int Original_AccountID, string Original_Username, string Original_Password) {
            return this.Update(Username, Password, Original_AccountID, Original_Username, Original_Password, Original_AccountID);
        }
        ...
        public virtual int CreateNewAccount(string Username, string Password) {
